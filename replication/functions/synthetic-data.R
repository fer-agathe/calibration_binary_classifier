...
#'   \eqn{\eta_i^u} is defined as follows: \deqn{\eta_i^u =\gamma \times \left( a_1 x_1 + a_2 x_2 +
#'   a_3 x_3 - a_4 x_4 + \varepsilon_i\right),} where \eqn{\varepsilon_i \sim
#'   \mathcal{N}(0, 0.5^2)} and where \eqn{(a_1,
#'   a_2, a_3, a_4) = (-0.1, 0.05, 0.2, -0.05)} by default.
#'
...
sim_data <- function(n_obs = 2000,
  ...
  if (length(a) != 4) stop("`a` must be a vector of numerical of length 4")
...
#'   probabilities are transformed and it may induce decalibration)
#' @param a vector of length 4 with values for \eqn{a}. Default to \eqn{(a_1,
#'   a_2, a_3, a_4) = (-0.1, 0.05, 0.2, -0.05)} in the DGP (see
#'   \code{\link{sim_data}})
#'
